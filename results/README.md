...
| Waveshare 15.6inch Universal Portable Touch Monitor, 1920×1080 Full HD | 10 | 124 → 124 Hz | 0.65 ms | ✔️ Stable polling rate all the way to 10 fingers, but ~125 Hz looks a bit mid-tier to me — I still saw a touch point drop occasionally with all 10 down at once, though fewer fingers seem fine | [Result](waveshare-15-6-universal-portable-touch-1080p/README.md) | [Waveshare](https://www.waveshare.com/15.6inch-FHD-Monitor.htm) |
