...
set "SRC=src\main.cpp src\ui.cpp src\tracker.cpp src\device.cpp src\display.cpp src\render.cpp src\export.cpp src\gzip.cpp src\hidtouch.cpp src\gridscan.cpp src\touchpad.cpp src\rawinput.cpp"
